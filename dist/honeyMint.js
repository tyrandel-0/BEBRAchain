...
import { honeyAbi, honeyMintAddress, usdcTokenAddress } from './abi/bexSwap.js';
...
export async function completeGalxeHoneyMintTask(providerUrl, privateKeys, delayTimeRange, proxies, proxyType) {
...
async function completeTaskForWallet(wallet, walletIndex, delay) {
    ...
    try {
        ...
        const usdcBalanceString = await checkERC20(wallet.provider, wallet.address, usdcTokenAddress);
        ...
        const mintAmount = getRandomInRange(convertToFloat("151", 18), convertToFloat(usdcBalanceString, 18) * 0.8);
        ...
        updateStatus(walletIndex, `approve tx result: ${(((_b = (await ((_a = wallet.provider) === null || _a === void 0 ? void 0 : _a.waitForTransaction(approveTxHash, undefined, 1200000)))) === null || _b === void 0 ? void 0 : _b.status) == 1) ? "success!" : "failed("}`);
        await sleep(4000);
        ...
        updateStatus(walletIndex, `mint tx result: ${(((_d = (await ((_c = wallet.provider) === null || _c === void 0 ? void 0 : _c.waitForTransaction(approveTxHash, undefined, 1200000)))) === null || _d === void 0 ? void 0 : _d.status) == 1) ? "success!" : "failed("}`);
    }
    catch (error) {
...
async function mintHoney(wallet, mintAmount) {
